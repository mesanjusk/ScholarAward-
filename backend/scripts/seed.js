...
async function run() {
  ...
  const roles = await Role.insertMany([
    ...
    { name: 'Admin', code: 'ADMIN', dashboardKey: 'admin', permissions: [PERMISSIONS.dashboard_view, PERMISSIONS.users_manage, PERMISSIONS.students_manage, PERMISSIONS.volunteers_manage, PERMISSIONS.categories_manage, PERMISSIONS.stage_manage, PERMISSIONS.guest_manage, PERMISSIONS.donation_manage, PERMISSIONS.whatsapp_send, PERMISSIONS.notifications_view, PERMISSIONS.budget_manage, PERMISSIONS.expense_manage, PERMISSIONS.vendor_manage, PERMISSIONS.task_manage, PERMISSIONS.team_manage, PERMISSIONS.certificate_manage] },
